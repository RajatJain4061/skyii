...
namespace modules\user\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use modules\user\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\modules\user\models\Menu]].
 * 
 */
